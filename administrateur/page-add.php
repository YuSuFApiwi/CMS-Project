            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="name-page" name="page_name" placeholder="Entrez le nom de la page">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-lowercase" id="slug-page" name="slug" placeholder="Exemple: à-propos-de-nous">
