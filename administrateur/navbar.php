...
<form
    ...
    <div class="input-group">
        <input type="text" class="form-control bg-light border-0 small" placeholder="Recherche ici..."
...
<ul class="navbar-nav ml-auto">
            ...
            <form class="form-inline mr-auto w-100 navbar-search">
                <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small"
                        placeholder="Recherche ici..." aria-label="Recherche"
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="<?php echo BASE_URL; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="Visiter le site web">
