...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a class="nav-link" id="nav-favicon-tab" data-toggle="tab" href="#nav-favicon" role="tab" aria-controls="nav-favicon" aria-selected="true">Icône de favori</a>
  </div>
</nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $meta_title ?>" required id="title" name="meta_title" placeholder="Meta Title">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
