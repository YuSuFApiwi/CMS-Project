            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="name-article" name="name_article" placeholder="Entrez le titre de l'actualité">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-lowercase" id="slug-page" name="slug" placeholder="Exemple: titre-de-l'actualite">
